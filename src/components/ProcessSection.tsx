            ...
            <div key={step.step} className="relative flex gap-6 md:gap-10">
              ...
              <div className="mb-10 flex-1 md:mb-14">
                <div className="flex flex-wrap items-center gap-3">
                  ...
                  <span className="inline-flex items-center gap-1 rounded-full border border-accent/20 bg-accent-light/50 px-3 py-0.5 text-[10px] font-semibold uppercase tracking-[0.05em] text-accent">
